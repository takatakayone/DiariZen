...
class Model(BaseModel):
    def __init__(
        ...
        # Replace ConformerEncoder with SambaEncoder (Microsoft Samba architecture)
    ...
    def forward(self, waveforms: torch.Tensor) -> torch.Tensor:
        ...
        # Use SambaEncoder instead of ConformerEncoder
        outputs = self.samba(outputs)
